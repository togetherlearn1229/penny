                ...
                <div className={`max-w-[80%] ${message.role === "user" ? "order-1" : "order-2"}`}>
                  <div className={`p-4 rounded-lg border ${
                    ...
                    <div className={`text-xs font-mono mb-2 opacity-60 ${
                      message.role === "user" ? "text-pink-300" : "text-cyan-300"
                    }`}>
                      {message.role === "user" ? "[USER_INPUT]" : "[AI_RESPONSE]"}
                    </div>
                    <p className="font-mono leading-relaxed whitespace-pre-wrap">{message.content}</p>
            ...
            <div className="mb-6 flex justify-start">
              <div className="max-w-[80%]">
                <div className="p-4 rounded-lg border bg-gradient-to-r from-green-900/30 to-cyan-900/30 border-cyan-400/30 text-cyan-100 shadow-lg neon-glow">
                  ...
                  {isStreaming && currentAssistantMessage ? (
                    <p className="font-mono leading-relaxed whitespace-pre-wrap">{currentAssistantMessage}</p>
                  ) : (
